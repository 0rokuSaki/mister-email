export const demoDataService = { getDemoData };
  ...
  return [
    {
      ...
      body: "Dear User, Thank you for your recent order. Your order has been confirmed and is now being processed. You will receive a shipping notification once your order has been dispatched. Regards, The Store Team",
      isRead: false,
      isStarred: false,
      sentAt: new Date(2024, 1, 5).getTime(),
      removedAt: null,
    ...
    },
    {
      ...
      body: "Hello, Your verification code is: 654321. Please use this code to verify your account. Thank you, The Verification Team",
      isRead: true,
      isStarred: false,
      sentAt: new Date(2024, 0, 10).getTime(),
      removedAt: null,
    ...
    },
    {
      ...
      body: "Dear User, We would like to inform you about the upcoming pension reforms. Please visit our website for more information on how these changes may affect you. Regards, The Pension Office",
      isRead: true,
      isStarred: true,
      sentAt: new Date(2024, 0, 17).getTime(),
      removedAt: null,
      from: "pension@example.com",
      to: "user@appsus.com",
    },
    {
      id: "e4",
      subject: "Government Elections",
      body: "Dear Citizen, Don't forget to cast your vote in the upcoming government elections. Your voice matters! Regards, The Election Commission",
      isRead: false,
      isStarred: false,
      sentAt: new Date(2024, 2, 2).getTime(),
      removedAt: null,
      from: "elections@example.com",
      to: "user@appsus.com",
    },
    {
      id: "e5",
      subject: "Important Information",
      body: "Dear User, We have detected suspicious activity on your account. Please log in to verify your identity and secure your account. Regards, Support Team",
      isRead: false,
      isStarred: false,
      sentAt: new Date(2024, 0, 7).getTime(),
      removedAt: null,
    ...
    },
    {
      id: "e6",
      subject: "Verification Code",
      body: "Hello, Your verification code is: 987654. Please use this code to verify your account. Thank you, The Verification Team",
      isRead: true,
      isStarred: false,
      sentAt: new Date(2024, 1, 5).getTime(), // February 5, 2024
      removedAt: null,
      from: "verification@example.com",
      to: "user@appsus.com",
    },
    {
      ...
      body: "Dear User, Your order (#789012) is now out for delivery. You can track your order using the provided tracking number. Regards, The Store Team",
      isRead: false,
      isStarred: false,
      sentAt: new Date(2024, 1, 10).getTime(), // February 10, 2024
      removedAt: null,
      from: "store@example.com",
      to: "user@appsus.com",
    },
    {
      id: "e8",
      subject: "Update on Pension Reforms",
      body: "Dear User, Please be advised that the implementation date for the pension reforms has been postponed. We will provide further updates as soon as possible. Regards, The Pension Office",
      isRead: false,
      isStarred: false,
      sentAt: new Date(2024, 1, 15).getTime(), // February 15, 2024
      removedAt: null,
      from: "pension@example.com",
      to: "user@appsus.com",
    },
    {
      id: "e9",
      subject: "Reminder: Government Elections",
      body: "Dear Citizen, This is a friendly reminder to vote in the government elections. Your vote counts! Regards, The Election Commission",
      isRead: false,
      isStarred: false,
      sentAt: new Date(2024, 1, 20).getTime(), // February 20, 2024
      removedAt: null,
      from: "elections@example.com",
      to: "user@appsus.com",
    },
    {
      id: "e10",
      subject: "Spam Alert",
      body: "Dear User, Please be cautious of suspicious emails claiming to be from our company. We will never ask for sensitive information via email. Regards, Security Team",
      isRead: false,
      isStarred: false,
      sentAt: new Date(2024, 1, 25).getTime(), // February 25, 2024
      removedAt: null,
    ...
    {
      id: "e004",
      subject: "You've Won a Lifetime Supply of Air!",
      body: "Congratulations! You've been selected as the lucky winner of a lifetime supply of air! 🎉🎈 Simply reply to this email with your bank account details and social security number to claim your prize. Act fast before someone else steals your breath away! 😂💨",
      isRead: false,
      isStarred: true,
      sentAt: Date.now(),
      removedAt: null,
      from: "sillyscams@example.com",
      to: "user@appsus.com",
    },
    {
      id: "e005",
      subject: "Exciting Opportunity Inside!",
      body: "Hello there! We have a thrilling opportunity waiting just for you! Open this email to uncover the surprise!",
      isRead: true,
      isStarred: false,
      sentAt: 1644698800010,
      removedAt: null,
      from: "opportunity@example.com",
      to: "user@appsus.com",
    },
    {
      id: "e006",
      subject: "Thinking of You!",
      body: "Hey there,\n\nJust wanted to drop you a quick note to let you know that I've been thinking about you a lot lately. Life just doesn't feel the same without your laughter and presence. Hope you're doing well, and let's catch up soon!\n\nSending you lots of love and virtual hugs,\n[Your Name]",
      isRead: false,
      isStarred: true,
      sentAt: 1685598812000,
      removedAt: null,
      from: "friend@example.com",
      to: "user@appsus.com",
    },
    {
      id: "e007",
      subject: "Exclusive Binary Options Opportunity!",
      body: "Hello,\n\nCongratulations! You've been specially selected to participate in an exclusive binary options trading opportunity. With our revolutionary system, you can earn massive profits in just minutes!\n\nDon't miss out on this limited-time offer. Act now and secure your financial future!\n\nTo get started, simply deposit $1000 into your account and follow the instructions provided. Remember, the more you invest, the more you'll earn!\n\nBest regards,\nThe Binary Options Team",
      isRead: true,
      isStarred: false,
      sentAt: 1697694812300,
      removedAt: 1698965120694,
      from: "binaryoptions@example.com",
      to: "user@appsus.com",
    },
    {
      id: "e102",
    ...
    {
      id: "e132",
      subject: "Your Exclusive February Offers!",
      body: "Dear Valued Customer, We're excited to present you with our exclusive February offers! As a token of appreciation for your continued support, we're offering special discounts and deals on a wide range of products throughout the month. From electronics to fashion, there's something for everyone. Don't miss out on this opportunity to save big and treat yourself or your loved ones to something special. Visit our website or store today to discover our latest offers and start saving! Best regards, The Sales Team",
      isRead: false,
      isStarred: false,
      sentAt: new Date(2024, 1, 15).getTime(), // February 15, 2024
      removedAt: null,
    ...
    },
    {
      ...
      body: "Hello, Your verification code is: 123456. Please use this code to verify your account. Thank you, The Verification Team",
      isRead: false,
      isStarred: false,
      sentAt: new Date(2024, 0, 25).getTime(), // January 25, 2024
      removedAt: null,
    ...
    {
      id: "e134",
      subject: "Urgent: Expected Hunger Crisis",
      body: "Dear Citizens, We regret to inform you of an expected hunger crisis in our country due to various factors, including crop failures, drought, and economic instability. Our government is closely monitoring the situation and taking immediate action to address the needs of affected communities. However, we urge all citizens to remain vigilant and support each other during these challenging times. If you or someone you know is in need of assistance, please reach out to local authorities or humanitarian organizations for help. Together, we can overcome this crisis and ensure no one goes hungry. Best regards, The Government",
      isRead: true,
      isStarred: false,
      sentAt: new Date(2024, 1, 10).getTime(), // February 10, 2024
      removedAt: null,
    ...
    },
    {
      ...
      body: "My dearest beloved, As I sit down to write this letter, my heart is overflowing with love for you. Every moment I spend with you fills my life with joy and happiness. Your laughter brightens my days, and your presence brings me comfort like no other. I want you to know how much you mean to me and how deeply I cherish our relationship. You are my soulmate, my confidant, and my best friend. I am grateful for every second we share together, and I look forward to a lifetime of making memories with you. With all my love, [Your Name]",
      isRead: false,
      isStarred: false,
      sentAt: new Date(2024, 1, 14).getTime(), // February 14, 2024 (Valentine's Day)
      removedAt: null,
      from: "user@appsus.com",
      to: "mylove@walla.com",
    }
